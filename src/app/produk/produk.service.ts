...
export class ProdukService extends BaseResponse {
  ...
  async create(payload: CreateProdukDto): Promise<ResponseSuccess> {
    try {
      await this.produkRepository.save(payload);
  ...
  async getDetail(id: number): Promise<ResponseSuccess> {
    try {
      ...
      return this._success('Detail Produk ditemukan', detail);
    } catch (err) {
      return err;
    }
  }
  ...
  async update(
    ...
    return this._success('Produk berhasil diupdate', update);
  }
  ...
  async delete(id: number): Promise<ResponseSuccess> {
    ...
    return this._success('Produk berhasil dihapus');
  }
}
